...
{
	partial class generalTextureListViewer
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "GeneralTexture List";
			// 
			// button1
			// 
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(143, 49);
			...
			// texturesPanel1
			// 
			this.texturesPanel1.Location = new System.Drawing.Point(12, 100);
			this.texturesPanel1.Margin = new System.Windows.Forms.Padding(4);
			this.texturesPanel1.Name = "texturesPanel1";
			this.texturesPanel1.Size = new System.Drawing.Size(552, 450);
			this.texturesPanel1.TabIndex = 4;
			// 
			// generalTextureListViewer
			// 
			...
			this.Name = "generalTextureListViewer";
			this.Text = "generalTextureListViewer";
